...
categories:
	- Node.js
keywords: Node.js，Node.js事件监听模块

---
### 一、视频地址
慕课网 http://www.imooc.com/video/8525
<!--more-->
### 二、直接上代码
...
### 三、不常用的事件模块自己去看API咯
### 四、其他建议
```EventEmitter.listenerCount(emitter, eventName)```已经废弃了，建议使用```emitter.listenerCount(eventName)```